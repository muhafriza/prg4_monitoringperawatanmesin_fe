...
export default function RiwayatKorektif({ onChangePage }) {
  ...
  const fetchDetailSP = async () => {
    try {
      const data = await UseFetch(
        API_LINK + "Korektif/getdetailSparepartPerawatanKorektifSelesai",
        { p1: "Selesai" }
      );
