...
export default function RiwayatPreventifTEKNISI({ onChangePage }) {
  ...
  const exportToExcel = async (periodFilter = null) => {
    try {
      ...
      const data = await UseFetch(
        API_LINK + "Korektif/GetDataPerawatanKorektifToExportTeknisi",
        {
    ...
    try {
      ...
      const data = await UseFetch(
        API_LINK + "Korektif/GetDataPerawatanKorektifToExportTeknisi",
        {
          ...
          p4: periodFilter?.end || "",
          p5: periode, // ✅ ambil dari state dropdown periode (tahun / all)
        }
      );
  ...
  // Ambil data detail (kalau ada kebutuhan tambahan seperti di Preventif)
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const data = await UseFetch(
          API_LINK + "Korektif/getDataPerawatanKorektifSelesaiTEKNISI",
          currentFilter
        );
        ...
        if (data === "ERROR") {
          ...
          const formattedData = data.map((value) => {
            ...
            console.log("format data: ", mes_upt);
            return {
              ...rest,
            ...
            <div className="flex-fill">
              <div className="input-group">
                ...
                <Button
                  ...
                  label="Export"
                  title="Export Laporan Perawatan Korektif"
